...
public:
  ...
  StrokeAttribute(float iRColor, float iGColor, float iBColor,
		  ...
		  float iRColorID, float iGColorID, float iBColorID);
   ...
   *    The new alpha value.
   */
  inline void setColorID(const Vec3f& iRGB) { _colorID[0]=iRGB[0]; _colorID[1]=iRGB[1]; _colorID[2]=iRGB[2]; }

  inline float * getColorID() { return _colorID; }

  inline const float  getColorIDR() const { return _colorID[0]; }
  /*! Returns the G color component. */
  inline const float  getColorIDG() const { return _colorID[1]; }
  /*! Returns the B color component. */
  inline const float  getColorIDB() const { return _colorID[2]; }
  /*! Returns the RGB color components. */
...
private:
  ...
  float _colorID[3];    // ID of the ViewEdge that this came from
};
...
public:
  ...
  /*! Returns the 2D point z coordinate */
