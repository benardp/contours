...
StrokeAttribute::StrokeAttribute(const StrokeAttribute& iBrother)
{
  ...
  if(iBrother._userAttributesVec3f)
    ...
    _userAttributesVec3f = 0;
  _colorID[0] = iBrother._colorID[0];
  _colorID[1] = iBrother._colorID[1];
  _colorID[2] = iBrother._colorID[2];
}
				  ...
				  float iRColorID, float iGColorID, float iBColorID)
{
  ...
  _colorID[0] = iRColorID;
  _colorID[1] = iGColorID;
  _colorID[2] = iBColorID;
...

{
  ...
  _colorID[0] = a1._colorID[0];
  _colorID[1] = a1._colorID[1];
  _colorID[2] = a1._colorID[2];
}
StrokeAttribute::~StrokeAttribute()
{
...
{
  _Attribute.setColorID(iSVertex->getColorID());
...
float Stroke::ComputeSampling(int iNVertices)
{
  ...
  float sampling = _Length/(float)(iNVertices/1);
