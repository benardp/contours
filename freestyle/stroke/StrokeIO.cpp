...
ostream& operator<<(ostream& out, const StrokeVertex& iStrokeVertex){
  ...
  out << "    2d coordinates     : (" << (double) iStrokeVertex.getProjectedX() << "," << (double) iStrokeVertex.getProjectedY() << "," << (double) iStrokeVertex.getProjectedZ() << ")" << endl;
  out << "    3d coordinates     : (" << (double) iStrokeVertex.getX() << "," << (double) iStrokeVertex.getY() << "," << (double) iStrokeVertex.getZ() << ")"<< endl;
...
ostream& operator<<(ostream& out, const Stroke& iStroke){
  ...
  out << "  length      : " << (double) iStroke.getLength2D() << endl;
