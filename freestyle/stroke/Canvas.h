...
public:
  ...
  /* Render one layer */
  void RenderLayer(const StrokeRenderer *iRenderer, int layer);
  ...
  inline StyleModule* getStyleModule(int i) { return _StyleModules.at(i); }
  inline int getNumStyleModules() { return _StyleModules.size(); }
