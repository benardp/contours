...
namespace OGF {
    ...
    namespace MatrixUtil {
        ...
        static const real EPS = 0.00001 ;
        static int MAX_ITER = 100 ;
        
        void semi_definite_symmetric_eigen(
            const real *mat, int n, real *eigen_vec, real *eigen_val
        ) {
            real *a,*v;
            real a_norm,a_normEPS,thr,thr_nn;
            int nb_iter = 0;
            int jj;
            int i,j,k,ij,ik,l,m,lm,mq,lq,ll,mm,imv,im,iq,ilv,il,nn;
            int *index;
            real a_ij,a_lm,a_ll,a_mm,a_im,a_il;
            real a_lm_2;
            real v_ilv,v_imv;
            real x;
            real sinx,sinx_2,cosx,cosx_2,sincos;
            real delta;
