...
/*
Grid::iterator FastGrid::begin()
{
  return FGiterator(_nonempty_cells.begin());
}
Grid::iterator FastGrid::end()
{
  return FGiterator(_nonempty_cells.end());
}
*/

FastGrid::FGiterator FastGrid::beginFG()
{
  return FGiterator(_nonempty_cells.begin());
}
FastGrid::FGiterator FastGrid::endFG()
{
  return FGiterator(_nonempty_cells.end());
}


FastGrid::FGiterator::FGiterator(const set<Vec3u>::iterator & setit)
{
  _setit = setit;
}

FastGrid::FGiterator::FGiterator(const FastGrid::FGiterator & it2)
{
  _setit = it2._setit;
}

void FastGrid::FGiterator::operator++()
{
  _setit ++;
}

bool FastGrid::FGiterator::operator!=(const FastGrid::FGiterator & it2) const
{
  return _setit != it2._setit;
}

Vec3u FastGrid::FGiterator::operator*() const
{
  return *_setit;
}


Vec3u FastGrid::FGiterator::dereference() const
{
  return *_setit;
}
