...
public:
  ...
  */
    IndexedFaceSet(real *iVertices, unsigned iVSize,
                    ...
                    int * faceUserData, float * vertexUserData,
                    unsigned iCopy = 1,
                    bool meshSilhouettes = false
            );
    ...
    virtual const int * faceUserData() { return _FaceUserData; }
    virtual const float * vertexUserData() { return _VertexUserData; }
