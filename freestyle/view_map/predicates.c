...
#define REALPRINT realprint
#define REALRAND realrand
#define NARROWRAND narrowrealrand
#define UNIFORMRAND uniformrealrand
...
/*****************************************************************************/
/*                                                                           */
/*  realprint()   Print the bit representation of a real.                */
/*                                                                           */
...
/*****************************************************************************/
/*                                                                           */
/*  realrand()   Generate a real with random 53-bit significand and a    */
...
real realrand()
{
  ...
  b = random();
  c = random();
  result = (real) (a - 1073741824) * 8388608.0 + (real) (b >> 8);
...
/*****************************************************************************/
/*                                                                           */
/*  narrowrealrand()   Generate a real with random 53-bit significand    */
...
/*****************************************************************************/
/*                                                                           */
/*  uniformrealrand()   Generate a real with random 53-bit significand.  */
/*                                                                           */
/*****************************************************************************/

real uniformrealrand()
{
  real result;
  long a, b;
