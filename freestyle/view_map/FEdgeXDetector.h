...
public:
  ...
  virtual void ProcessSilhouetteFace(WXFace *iFace, bool meshSilhouettes);
  virtual void ProcessSilhouetteEdge(WXEdge *iEdge, bool meshSilhouettes);
  ...
  //  virtual void processSurfaceIntersections(WXShape* iShape);
