...
namespace Nature {
  ...
  /*! true at crossing into/out of a punch-out/inconsistent boundary !*/
  static const VertexNature PO_BOUNDARY         = (1 << 5);     // 32
  ...
  static const EdgeNature SURFACE_INTERSECTION  = (1 << 6);     // 64

  static const EdgeNature PO_SURFACE_INTERSECTION= (1 << 7);    // 128



  static const EdgeNature ALL_INTERSECTION = SURFACE_INTERSECTION | PO_SURFACE_INTERSECTION;
