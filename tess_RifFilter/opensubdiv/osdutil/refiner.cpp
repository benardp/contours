...
static void
_InverseNormalize(OpenSubdiv::FarPatchParam::BitField bf, real& u, real& v)
{
    real frac = bf.GetParamFraction();
    real pu = (real) bf.GetU() * frac;
    real pv = (real) bf.GetV() * frac;
...
static void
_InverseRotate(OpenSubdiv::FarPatchParam::BitField bf, real& u, real& v)
{
    switch (bf.GetRotation()) {
         case 0 : break;
         case 1 : { real tmp=u; u=1.0f-v; v=tmp; } break;
         case 2 : { u=1.0f-u; v=1.0f-v; } break;
         case 3 : { real tmp=v; v=1.0f-u; u=tmp; } break;
    }
}

bool
OsdUtilRefiner::GetRefinedPtexUvs(vector<real>* subfaceUvs,
                                    ...
                                    string *errorMessage) const
{
    ...
    vector<real>::iterator uvIt = subfaceUvs->begin();
