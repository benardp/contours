...
class OsdUtilUniformEvaluator {
  public:
    ...
    //
    bool GetRefinedPositions(const real **positions, int *numFloats,
    ...
    //
    bool GetRefinedVVData(real **data, int *numFloats,
    ...
    bool GetRefinedPtexUvs(std::vector<real>* subfaceUvs,
