...
public:
    ...
    void BindVertexBuffers( OsdVertexBufferDescriptor const & iDesc, INPUT_BUFFER *inQ,
                            OsdVertexBufferDescriptor const & oDesc, OUTPUT_BUFFER *outQ,
                                                                     ...
                                                                     OUTPUT_BUFFER *outdQudQu=0,
                                                                     OUTPUT_BUFFER *outdQvdQv=0,
                                                                     OUTPUT_BUFFER *outdQudQv=0) {
        ...
        _currentBindState.vertexData.outDuDu = outdQudQu ? outdQudQu->BindCpuBuffer() : 0;
        _currentBindState.vertexData.outDvDv = outdQvdQv ? outdQvdQv->BindCpuBuffer() : 0;
        _currentBindState.vertexData.outDuDv = outdQudQv ? outdQudQv->BindCpuBuffer() : 0;
    }
