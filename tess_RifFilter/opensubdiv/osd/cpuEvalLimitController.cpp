...
OsdCpuEvalLimitController::_EvalLimitSample( OpenSubdiv::OsdEvalCoords const & coords, 
    ...
    if (vertexData.IsBound()) {
        ...
        if (vertexData.IsBound()) {
            ...
            real * out   = vertexData.out.GetData()+offset,
                  ...
                  * outDuDu = vertexData.outDuDu.IsBound() ? vertexData.outDuDu.GetData()+offset : 0,
                  * outDvDv = vertexData.outDvDv.IsBound() ? vertexData.outDvDv.GetData()+offset : 0,
                  * outDuDv = vertexData.outDuDv.IsBound() ? vertexData.outDuDv.GetData()+offset : 0;
