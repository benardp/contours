...
Operators.select(AndUP1D(pyNatureUP1D(BORDER),QuantitativeInvisibilityUP1D(0)))
Operators.bidirectionalChain(ChainSilhouetteIterator(),NotUP1D( pyNatureUP1D( BORDER) ) )
shaders_list = 	[
