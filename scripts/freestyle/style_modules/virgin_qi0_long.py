...
Operators.select(NotUP1D(pyHighViewMapDensityUP1D(0.06, 5)))
Operators.select(pyHighViewMapDensityUP1D(0.044, 5))
shaders_list = 	[
		SamplingShader(2),
		TextureAssignerShader(5),
		SmoothingShader(100, 0.1, 0, 0.2, 0, 0, 0, 1),
		IncreasingThicknessShader(1, 5),
		IncreasingColorShader(0.5,0.0,0.1, 0.3, 0.4, 0.0, 0.0, 0.4)
		]
