...
###   I THINK THIS FILE IS NOT USED; SEE ChainingIterators.cpp INSTEAD.  (NOT SURE)
###   -Aaron
...
class pyChainSilhouetteIterator(ChainingIterator):
	...
	def traverse(self, iter):
		...
		if(nextVertex.getNature() & T_VERTEX != 0):
			...
			## case of NonTVertex
			natures = [SILHOUETTE,BORDER,CREASE,SUGGESTIVE_CONTOUR,VALLEY,RIDGE,SURFACE_INTERSECTION,PO_SURFACE_INTERSECTION]
...
class pyFillOcclusionsRelativeChainingIterator(ChainingIterator):
	...
	def traverse(self, iter):
		...
		if(nextVertex.getNature() & T_VERTEX != 0):
			...
			## case of NonTVertex
			natures = [SILHOUETTE,SURFACE_INTERSECTION,BORDER,CREASE,SUGGESTIVE_CONTOUR,VALLEY,RIDGE]
			for nat in natures:
